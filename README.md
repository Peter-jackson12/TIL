...
└── 2026-08/                  # 2026년 8월 학습 기록
    ...
    | **2026-09-02** | ML / Algo / Quant | 이분 탐색과 B+Tree 인덱스 연계, 원-핫 인코딩과 경사하강법 수리 증명, OLS # 📚 Data Science & AI Bootcamp — TIL & Devlog
...
```정규방정식(SSE) 구현, RTX 5060 환경 및 KIS End-to-End 퀀트 아키텍처 | [📄 보기](./2026-09/2026-09-02.md) |
```
